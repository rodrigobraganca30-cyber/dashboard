...
"""
patch_meta_v4.py
Insere o Gerenciador de Templates Meta com curly braces corretamente
escapados para serem validos dentro do f-string do whatsapp_agenda_gen.py.
"""
import sys
...
# ── HTML: { e } que sao literais HTML precisam ser {{ e }} dentro do f-string ─
# Nota: {1}, {2} no placeholder do textarea viram {{1}}, {{2}}
        ...
        <div>
          ...
          <div id="tpl-table-wrap" style="max-height:420px;overflow-y:auto">
            <table class="data-table" style="font-size:12px">
              ...
              <tbody id="tpl-tbody">
                <tr><td colspan="4" style="text-align:center;color:#64748b;padding:24px">Clique em "Atualizar" para carregar</td></tr>
              </tbody>
            </table>
          </div>
...
# ── JS: TODOS os { } de JS viram {{ }} para ser valido dentro do f-string ─────
JS_BLOCK = """
